# SuiteTooth_Framework

A Python Bluetooth scanning framework that compiles the most common and even uncommon bluetooth vulnerabilities. These include btlejuice, bluescan, blueborne, BluetoothDOSAttack with more to come as more get discovered. 
The framework scans for any open bluetooth signals, connects to it and automatically runs a suite of bluetooth vulnerabilities to test risk.
